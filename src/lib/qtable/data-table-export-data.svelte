<script lang="ts">
	...
	function onClick() {
		alert('Sorry, this feature is under contruction.');
	}
</script>

<Button on:click={onClick} variant="outline" size="sm" class="ml-auto flex h-8">
	<DownloadCloud class="h-4 w-4" />
	<span class="ml-2 hidden sm:block">Export</span>
</Button>
